...
class UsuarioAutentificado extends StatefulWidget {
  ...
  UsuarioAutentificado(this.user, {super.key});

  @override
  State<UsuarioAutentificado> createState() => _UsuarioAutentificado();
}

class _UsuarioAutentificado extends State<UsuarioAutentificado> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Headerver(widget.user, -1),
