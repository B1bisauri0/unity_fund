...
class AnhadirAlBalanceVer extends StatefulWidget {
  User user;
  AnhadirAlBalanceVer(this.user, {super.key});

  @override
  _AnhadirAlBalanceVerState createState() => _AnhadirAlBalanceVerState();
}

class _AnhadirAlBalanceVerState extends State<AnhadirAlBalanceVer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Headerver(widget.user, 6),
