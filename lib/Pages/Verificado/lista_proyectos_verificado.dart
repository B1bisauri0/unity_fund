...
class ListaProyectosVerificado extends StatefulWidget {
  final User usuario;
  const ListaProyectosVerificado(this.usuario, {super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ListaProyectosVerificadoState createState() =>
      _ListaProyectosVerificadoState();
}

class _ListaProyectosVerificadoState extends State<ListaProyectosVerificado> {
