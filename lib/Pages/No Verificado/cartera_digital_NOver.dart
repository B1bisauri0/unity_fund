...
class CarteraDigitalNOVer extends StatefulWidget {
  final User user;
  const CarteraDigitalNOVer(this.user, {super.key});

  @override
  _CarteraDigitalNoVerState createState() => _CarteraDigitalNoVerState();
}

class _CarteraDigitalNoVerState extends State<CarteraDigitalNOVer> {
