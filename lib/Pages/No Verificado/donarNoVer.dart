...
class Donarnover extends StatefulWidget {
  Proyecto proyecto;
  User usuario;
  Donarnover(this.proyecto, this.usuario, {super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DonarnoverState createState() => _DonarnoverState();
}

class _DonarnoverState extends State<Donarnover> {
  late String title;
  late String texto;
  late double meta;
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  CarddonarNoVer(widget.proyecto, widget.usuario),
                ],
              ),
            ],
          ),
