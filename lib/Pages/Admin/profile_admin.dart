...
class UsuarioAdmin extends StatefulWidget {
  User user; // Recibe un objeto de tipo User

  UsuarioAdmin(this.user, {super.key});

  @override
  State<UsuarioAdmin> createState() => _UsuarioAdmin();
}

class _UsuarioAdmin extends State<UsuarioAdmin> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Headeradmin(widget.user, -1),
