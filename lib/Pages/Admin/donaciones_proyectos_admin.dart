...
class DonacionesProyectosAdmin extends StatefulWidget {
  Proyecto proyecto;
  User user;
  DonacionesProyectosAdmin(this.user, this.proyecto, {super.key});

  @override
  _MisDonacionesAdminState createState() => _MisDonacionesAdminState();
}

class _MisDonacionesAdminState extends State<DonacionesProyectosAdmin> {
