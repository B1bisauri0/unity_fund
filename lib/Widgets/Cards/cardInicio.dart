      ...
      case 10:
        {
          ...
          listaText.add(
              'Observa entre todos las donaciones realizadas hasta la fecha, con todos sus detalles como lo son el monto de dinero realizado para la donación y el usuario que realizó dicha donación. Presiona el botón para acceder al monitoreo de donaciones!');
          break;
        }
      // Tipo 11 Gestion de Usuarios
      case 11:
        {
          weight = 440;
          height = 340;
          ...
          listaText.add(
              'Visualiza una lista de todos los usuario registrados de la página. Como administrador posees la capacidad de activar o desactivar cuentas como lo creas necesario. Presiona el botón para acceder a la lista de usuarios de usuarios de la página!');
          break;
        }
      // Tipo 12 Monitoreo de Proyectos
      case 12:
        {
          weight = 440;
          height = 340;
          ...
          listaText.add(
              'Observa entre todos los proyectos que hay como administrador, por lo que tendrás podrás visualizar todos los proyectos, tanto los que ya acabaron su campaña de donación como los que siguen activos.Presiona el botón para acceder al monitoreo de donaciones!');
          break;
        }
      // Tipo 12 Monitoreo de Proyectos
      case 13:
        {
          ...
          listaText.add(
              'Como administrador, posees el acceso completo a las estadísticas acerca de los proyectos. Estas estadísticas incluyen la cantidad de proyectos, las donaciones realizadas a los proyectos y los usuarios de la aplicación que se mantienen activos. Presiona el botón para acceder a la a las estadísticas del sistema!');
          break;
        }
    }
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                minimumSize: Size(screenWeight * 0.3, screenHeight * 0.05),
              ),
              child: Text(
                button,
                style: TextStyle(
