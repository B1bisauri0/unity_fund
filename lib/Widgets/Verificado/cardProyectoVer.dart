...
import 'package:unity_fund/Pages/Verificado/detalle_proyecto_verificado.dart';
import 'package:unity_fund/data/proyectos.dart';
import 'package:unity_fund/data/users.dart';

// ignore: must_be_immutable
class Cardproyectover extends StatelessWidget {
  final Proyecto proyecto;
  final formatter = NumberFormat("#,##0.00", "es_ES");
  User usuario;

  Cardproyectover(this.proyecto, this.usuario, {Key? key}) : super(key: key);
              ...
              child: FloatingActionButton(
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          DetalleProyectoVerificado(proyecto, usuario),
                    ),
                  );
                },
